...
log_level = 'INFO'
work_dir = '/home/star/user/HEYU/tr3d/work_dirs/DynamicFrustum/DynamicFrustum_softlaber_Offset_another100_1GPU_24eh_1/5'
...
train_pipeline = [
    ...
    dict(type='PointSample', num_points=300000),
    dict(
        type='RandomFlip3D',
        sync_2d=False,
